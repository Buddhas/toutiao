    ...
    <transition name="search">
        <div class="search" :class="{no_result:inputText.length && searchList.length == 0}">
            ...
            <div class="search-result" v-show="inputText" >
                <scroll class="scroll-item" :listenScroll="true" :data="searchList" v-show="searchList.length">
                    <div>
                        <news-list :newsList="searchList" @selcted="saveKeyWork"></news-list>
                    </div>
                </scroll>
                <div v-show="loading && searchList.length == 0" class="loading" style="text-align: center">
